...
export class TranslationService {
    ...
    public initLanguageFromBrowser(): void {
      ...
      sessionStorage.setItem("selectedLanguage",this.currentLanguage.match(/en|el|se|de|nl|sl|no|dk|it/) ? this.currentLanguage : 'en')
      this._translate.use(this.currentLanguage.match(/en|el|se|de|nl|sl|no|dk|it/) ? this.currentLanguage : 'en');
    }
