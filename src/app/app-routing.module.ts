...
const appRoutes: Routes = [
  ...
  { path: 'admin/user-list', component: UserListComponent, canActivate: [AuthGuard], data: { roles: [Role.Admin], claims: [] } },
  { path: 'admin/user-profile', component: UserProfileComponent, canActivate: [AuthGuard], data: { roles: [Role.Admin], claims: [] } },
  { path: 'admin/datasource-repo', component: DatasourceRepositoryComponent, canActivate: [AuthGuard], data: { roles: [Role.Admin], claims: [] } },
  ...
  { path: 'user/dss/use-dashboard', component: DssUseDashboardComponent , canActivate: [AuthGuard] , data: { roles: [Role.Admin], claims: ['Developer', 'Advisor'] } },
  { path: 'user/dss/use-dashboard/edit', component: DssUseDashboardEditComponent , canActivate: [AuthGuard] , data: { roles: [Role.Admin], claims: ['Developer', 'Advisor'] } },
  { path: 'user/dss/evaluation-dashboard', component: DssEvaluationDashboardComponent , canActivate: [AuthGuard] , data: { roles: [Role.Admin], claims: ['Developer', 'Advisor'] } },
  { path: 'user/dss/adaptation-dashboard', component: DssAdaptationDashboardComponent , canActivate: [AuthGuard] , data: { roles: [Role.Admin], claims: ['Developer', 'Advisor'] } },
  { path: 'user/dss/integration-dashboard', component: DssIntegrationDashboardComponent , canActivate: [AuthGuard] , data: { roles: [Role.Admin], claims: ['Developer', 'Advisor'] } },
  { path: 'user/dss/list', component: DssListComponent , canActivate: [AuthGuard] , data: { roles: [Role.Admin], claims: ['Developer', 'Advisor'] } },
  { path: 'user/dss/details', component: DssDetailComponent , canActivate: [AuthGuard] , data: { roles: [Role.Admin], claims: ['Developer', 'Advisor'] } },
  { path: 'user/dss/details/observation-list', component: DssObservationListComponent , canActivate: [AuthGuard] , data: { roles: [Role.Admin], claims: ['Developer', 'Advisor'] } },
  { path: 'user/dss/details/observation-list/add', component: AddDssObservationComponent , canActivate: [AuthGuard] , data: { roles: [Role.Admin], claims: ['Developer', 'Advisor'] } },
  { path: 'user/dss/details/observation-list/edit', component: EditDssObservationComponent , canActivate: [AuthGuard] , data: { roles: [Role.Admin], claims: ['Developer', 'Advisor'] } },
  { path: 'user/dss/details/parameters-description', component: DssParametersDescriptionComponent , canActivate: [AuthGuard] , data: { roles: [Role.Admin], claims: ['Developer', 'Advisor'] } },
  { path: 'user/dss/details/parameters-description/weather-parameters-detail', component: WeatherParametersDetailComponent , canActivate: [AuthGuard] , data: { roles: [Role.Admin], claims: ['Developer', 'Advisor'] } },
  { path: 'user/dss/details/inputs-description', component: DssInputsDescriptionComponent , canActivate: [AuthGuard] , data: { roles: [Role.Admin], claims: ['Developer', 'Advisor'] } },
  { path: 'user/dss/details/outputs-description', component: DssOutputsDescriptionComponent , canActivate: [AuthGuard] , data: { roles: [Role.Admin], claims: ['Developer', 'Advisor'] } },
  { path: 'user/dss/details/parameters-detail', component: DssParametersDetailComponent , canActivate: [AuthGuard] , data: { roles: [Role.Admin], claims: ['Developer', 'Advisor'] } },
  { path: 'user/dss/details/platform-status/dss-status-detail', component: DssStatusDetailComponent , canActivate: [AuthGuard] , data: { roles: [Role.Admin], claims: ['Developer', 'Advisor'] } },
  { path: 'user/dss/details/platform-status', component: DssPlatformStatusComponent , canActivate: [AuthGuard] , data: { roles: [Role.Admin], claims: ['Developer', 'Advisor'] } },
  { path: 'user/dss/details/update-parameters', component: UpdateParametersComponent , canActivate: [AuthGuard] , data: { roles: [Role.Admin], claims: ['Developer', 'Advisor'] } }
];
